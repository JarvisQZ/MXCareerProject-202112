# -*- coding: utf-8 -*-
"""
@Time : 2022/1/13 22:51 
@Author : Zhi QIN 
@File : Leetcode1423. 可获得的最大点数 .py
@Software: PyCharm
@Brief : 23:31	info
			解答成功:
			执行耗时:76 ms,击败了91.28% 的Python3用户
			内存消耗:24.1 MB,击败了100.00% 的Python3用户
"""
...
#
#  Related Topics 数组 前缀和 滑动窗口 👍 205 👎 0
...
class Solution:
    def maxScore(self, cardPoints: List[int], k: int) -> int:
        ...
        min_window = window = sum(cardPoints[:window_size])
